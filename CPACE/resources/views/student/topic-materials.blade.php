    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .topic-hero {
            ...
            box-shadow:0 2px 10px rgba(0,0,0,.05); border:1px solid #f0f0f0; border-left:5px solid {{ $subject->color ?: '#7B1D1D' }};
        }
        ...
        .material-card {
            ...
            box-shadow:0 2px 8px rgba(0,0,0,.04); border:1px solid #f0f0f0; transition:box-shadow .2s;
        }
        ...
        <div class="top-bar-left">
            <div>
                <div class="breadcrumb">
                    <a href="{{ route('subjects') }}">Resources</a>
                    <span>/</span>
